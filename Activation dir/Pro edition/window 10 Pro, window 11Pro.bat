@echo off
color 17
echo Windows 10 , 11 pro Activation using Key Management Services (KMS) client activation and product keys
...
cls 
color b
echo Windows pro editions activation done successfully..
